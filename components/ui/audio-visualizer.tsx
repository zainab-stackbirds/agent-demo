...
export function AudioVisualizer({
    ...
    // Ref for fade-in animation timing
    ...
    const draw = () => {
        ...
        const drawFrame = () => {
            ...
            // Set transform for device pixel ratio
            ctx.scale(dpr, dpr)
            ...
            // Restore context state (resets transform and alpha)
            ctx.restore()
        }
